 ...
 <main>
    ...
    <section class="hero__area hero__height hero__height-2 d-flex align-items-center blue-bg-3 p-relative fix">
       <div class="hero__shape">
          <img class="hero-1-circle" src="{{ asset('img/frontend/img/shape/hero/hero-1-circle.png') }}" alt="">
          <img class="hero-1-circle-2" src="{{ asset('img/frontend/img/shape/hero/hero-1-circle-2.png') }}" alt="">
          <img class="hero-1-dot-2" src="{{ asset('img/frontend/img/shape/hero/hero-1-dot-2.png') }}" alt="">
       </div>
       <div class="container">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                   <div class="hero__content hero__content-2 p-relative z-index-1">
                      <h3 class="hero__title hero__title-2">
                         Launch your <br> Own
                         <span class="yellow-shape">online <img src="{{ asset('img/frontend/img/shape/yellow-bg.png') }}" alt="yellow-shape"> </span>
                         learning Platform
                      </h3>
                      ...
                      <div class="hero__search">
                         <form action="#">
                            <div class="hero__search-input mb-10">
                               ...
                               <a href=#trainers><button type="submit"><i class="fad fa-search"></i></button></a>
                            </div>
                         </form>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                   <div class="hero__thumb-wrapper mb--120">
                      <div class="hero__thumb-2 scene">
                         <img class="hero-big" src="{{ asset('img/frontend/img/hero/hero-2/hero.png') }}" alt="">
                         <img class="hero-shape-purple" src="{{ asset('img/frontend/img/hero/hero-2/hero-shape-purple.png') }}" alt="">
                         ...
                         <div class="hero__class d-none d-lg-flex layer" data-depth="0.3">
                            <div class="hero__class-thumb mr-15">
                               <img src="{{ asset('img/frontend/img/hero/hero-2/hero-sm.jpg') }}" alt="">
                            </div>
    ...
    <section class="events__area pt-115 pb-120 p-relative" id="trainers">
       <div class="events__shape">
          <img class="events-1-shape" src="{{ asset('img/frontend/img/events/events-shape.png') }}" alt="">
       </div>
          ...
          <div class="row">
             <div class="col-xxl-4 offset-xxl-4">
                <div class="section__title-wrapper mb-60 text-center">
                   <h2 class="section__title">Nearby <span class="yellow-bg yellow-bg-big">Trainers<img
                            src="{{ asset('img/frontend/img/shape/yellow-bg.png') }}" alt=""></span></h2>
                   <p>We found 5 trainers available for you.</p>
                </div>
             </div>
          </div>
             ...
             <div class="fixed">
                ...
                <div class="card-columns">
                   <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                      <div class="events__item mb-10">
                         <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                            <div class="col-sm-12">
                               <div class="card">
                                  <div class="card-media">
                                     <img src="{{ asset('img/frontend/images/teacher.jpg') }}" alt="product name">
                                  </div>
                                  <div class="card-body">
                                     <h5 class="card-title">
                                        <h3>NAME OF THE TRAINER</h3>
                                     </h5>
                                     <p class="card-text">
                                     ...
                                     <div class="card-footer">
                                        <div class="card-info">
                                           ...
                                           <span class="fa fa-star"></span>
                                           <small>
                                              <br> Availability : Available <br> Place : Mumbai <br> Distance : 1km
                                           </small>
                                           </div>
                                           <div class="card-btn">
          ...
          <div class="row">
             <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
                <div class="section__title-wrapper section-padding mb-60 text-center">
                   <h2 class="section__title">Why an <span class="yellow-bg">scholercity <img src="{{ asset('img/frontend/img/shape/yellow-bg-2.png') }}" alt=""></span> out of The ordinary</h2>
             ...
             <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="services__item blue-bg-4 mb-30">
                   ...
                   <div class="services__content">
                      <h3 class="services__title"><a href="about.html">4,000 <br> Online courses</a></h3>
             ...
             <div class="col-xxl-5 offset-xxl-1 col-xl-6 col-lg-6">
                <div class="about__thumb-wrapper">
                   ...
                   <div class="about__thumb ml-100">
                      <img src="{{ asset('img/frontend/img/about/about.jpg') }}" alt="">
                   </div>
                   <div class="about__banner mt--210">
                      <img src="{{ asset('img/frontend/img/about/about-banner.jpg') }}" alt="">
                   </div>
                   <div class="about__student ml-270 mt--80">
                      <a href="#">
                         <img src="{{ asset('img/frontend/img/about/student-4.jpg') }}" alt="">
                         <img src="{{ asset('img/frontend/img/about/student-3.jpg') }}" alt="">
                         <img src="{{ asset('img/frontend/img/about/student-2.jpg') }}" alt="">
                         <img src="{{ asset('img/frontend/img/about/student-1.jpg') }}" alt="">
                      </a>
             ...
             <div class="col-xxl-6 col-xl-6 col-lg-6">
                <div class="about__content pl-70 pr-60 pt-25">
                   <div class="section__title-wrapper mb-25">
                      <h2 class="section__title">Achieve your <br><span class="yellow-bg-big">Goals <img src="{{ asset('img/frontend/img/shape/yellow-bg-2.png') }}" alt=""></span>  with Educal </h2>
          ...
          <div class="row align-items-end">
             <div class="col-xxl-5 col-xl-6 col-lg-6">
                <div class="section__title-wrapper mb-60">
                   <h2 class="section__title">Find the Right<br>Online <span class="yellow-bg yellow-bg-big">Course<img src="{{ asset('img/frontend/img/shape/yellow-bg.png') }}" alt=""></span> for you</h2>
                   <p>You don't have to struggle alone, you've got our assistance and help.</p>
                </div>
             </div>
          ...
          <div class="row grid">
                ...
                <div class="course__item white-bg mb-30 fix">
                   <div class="course__thumb w-img p-relative fix">
                      <a href="course-details.html">
                         <img src="{{ asset('img/frontend/img/course/course-1.jpg') }}" alt="">
                      </a>
                   ...
                   <div class="course__content">
                      ...
                      <div class="course__teacher d-flex align-items-center">
                         <div class="course__teacher-thumb mr-15">
                            <img src="{{ asset('img/frontend/img/course/teacher/teacher-1.jpg') }}" alt="">
                         </div>
             ...
             <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat3 cat4">
                <div class="course__item white-bg mb-30 fix">
                   <div class="course__thumb w-img p-relative fix">
                      <a href="course-details.html">
                         <img src="{{ asset('img/frontend/img/course/course-2.jpg') }}" alt="">
                      </a>
                      <div class="course__tag">
                   ...
                   <div class="course__content">
                      ...
                      <div class="course__teacher d-flex align-items-center">
                         <div class="course__teacher-thumb mr-15">
                            <img src={{ asset('img/frontend/img/course/teacher/teacher-2.jpg') }} alt="">
                         </div>
             ...
             <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat3 cat4 cat3">
                <div class="course__item white-bg mb-30 fix">
                   <div class="course__thumb w-img p-relative fix">
                      <a href="course-details.html">
                         <img src="{{ asset('img/frontend/img/course/course-3.jpg') }}" alt="">
                      </a>
                      <div class="course__tag">
                   ...
                   <div class="course__content">
                      ...
                      <div class="course__teacher d-flex align-items-center">
                         <div class="course__teacher-thumb mr-15">
                            <img src="{{ asset('img/frontend/img/teacher/teacher-3.jpg') }}" alt="">
                         </div>
             ...
             <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat4 cat1 cat3">
                <div class="course__item white-bg mb-30 fix">
                   <div class="course__thumb w-img p-relative fix">
                      <a href="course-details.html">
                         <img src="{{ asset('img/frontend/img/course/course-4.jpg') }}" alt="">
                      </a>
                      <div class="course__tag">
                   ...
                   <div class="course__content">
                      ...
                      <div class="course__teacher d-flex align-items-center">
                         <div class="course__teacher-thumb mr-15">
                            <img src="{{ asset('img/frontend/img/course/teacher/teacher-4.jpg') }}" alt="">
                         </div>
             ...
             <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2 cat4">
                <div class="course__item white-bg mb-30 fix">
                   <div class="course__thumb w-img p-relative fix">
                      <a href="course-details.html">
                         <img src="{{ asset('img/frontend/img/course/course-5.jpg') }}" alt="">
                      </a>
                      <div class="course__tag">
                   ...
                   <div class="course__content">
                      ...
                      <div class="course__teacher d-flex align-items-center">
                         <div class="course__teacher-thumb mr-15">
                            <img src="{{ asset('img/frontend/img/course/teacher/teacher-5.jpg') }}" alt="">
                         </div>
             ...
             <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat3">
                <div class="course__item white-bg mb-30 fix">
                   <div class="course__thumb w-img p-relative fix">
                      <a href="course-details.html">
                         <img src="{{ asset('img/frontend/img/course/course-6.jpg') }}" alt="">
                      </a>
                      <div class="course__tag">
                   ...
                   <div class="course__content">
                      ...
                      <div class="course__teacher d-flex align-items-center">
                         <div class="course__teacher-thumb mr-15">
                            <img src="{{ asset('img/frontend/img/course/teacher/teacher-6.jpg') }}" alt="">
                         </div>
       ...
       <div class="container">
          <div class="row">
             <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                <div class="section__title-wrapper mb-60 text-center">
                   <h2 class="section__title">What is <span class="yellow-bg-big">Skilline? <img src="{{ asset('img/frontend/img/shape/yellow-bg-2.png') }}" alt=""></span></h2>
          ...
          <div class="row">
             <div class="col-xxl-5 offset-xl-1 col-xl-5 offset-xl-1 col-lg-6">
                <div class="what__item transition-3 mb-30 p-relative fix">
                   <div class="what__thumb w-img">
                      <img src="{{ asset('img/frontend/img/what/what-1.jpg') }}" alt="">
                   </div>
             ...
             <div class="col-xxl-5 col-xl-5 col-lg-6">
                <div class="what__item transition-3 mb-30 p-relative fix">
                   <div class="what__thumb w-img">
                      <img src="{{ asset('img/frontend/img/what/what-2.jpg') }}" alt="">
                   </div>
                   <div class="what__content p-absolute text-center">
          ...
          <div class="row align-items-center">
             <div class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-6 col-md-8">
                <div class="why__content pr-50 mt-40">
                   <div class="section__title-wrapper mb-30">
                      ...
                      <h2 class="section__title">Tools for <span class="yellow-bg yellow-bg-big">Teachers<img src="{{ asset('img/frontend/img/shape/yellow-bg.png') }}" alt=""></span> and Learners</h2>
             ...
             <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-8">
                <div class="why__thumb">
                   <img src="{{ asset('img/frontend/img/why/why.png') }}" alt="">
                   <img class="why-green" src="{{ asset('img/frontend/img/why/why-shape-green.png') }}" alt="">
                   <img class="why-pink" src="{{ asset('img/frontend/img/why/why-shape-pink.png') }}" alt="">
                   <img class="why-dot" src="{{ asset('img/frontend/img/why/why-shape-dot.png') }}" alt="">
                   <img class="why-line" src="{{ asset('img/frontend/img/why/why-shape-line.png') }}" alt="">
                </div>
             </div>
          </div>
       </div>
          ...
          <div class="row">
             <div class="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3">
                <div class="section__title-wrapper text-center mb-60">
                   <h2 class="section__title">We are <span class="yellow-bg yellow-bg-big">Proud<img src="{{ asset('img/frontend/img/shape/yellow-bg.png') }}" alt=""></span></h2>
                   <p>You don't have to struggle alone, you've got our assistance and help.</p>
                </div>
             </div>
          </div>
    ...
    <section class="testimonial__area testimonial__overlay pt-175 pb-170" data-background="{{ asset('img/frontend/img/testimonial/testimonial-bg.jpg') }}">
       <div class="container">
                ...
                <div class="testimonial__slider-inner swiper-wrapper">
                   <div class="testimonial__item text-center swiper-slide">
                      <div class="testimonial__thumb">
                         <img src="{{ asset('img/frontend/img/testimonial/testi-1.jpg') }}" alt="">
                      </div>
             ...
             <div class="col-xxl-6 offset-xxl-3">
                <div class="section__title-wrapper text-center mb-60">
                   <h2 class="section__title">We share <br>
                      Our <span class="yellow-bg yellow-bg-big">thoughts <img src="{{ asset('img/frontend/img/shape/yellow-bg.png') }}" alt=""></span>on design</h2>
                   <p>You don't have to struggle alone, you've got our assistance and help.</p>
                </div>
             </div>
          </div>
          <div class="row">
                ...
                <div class="blog__item white-bg mb-30 transition-3 fix">
                   <div class="blog__thumb w-img fix">
                      <a href="blog-details.html">
                         <img src="{{ asset('img/frontend/img/blog/blog-1.jpg') }}" alt="">
                      </a>
                   </div>
                      ...
                      <div class="blog__meta d-flex align-items-center justify-content-between">
                         <div class="blog__author d-flex align-items-center">
                            <div class="blog__author-thumb mr-10">
                               <img src="{{ asset('img/frontend/img/blog/author/author-1.jpg') }}" alt="">
                            </div>
             ...
             <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                <div class="blog__item white-bg mb-30 transition-3 fix">
                   <div class="blog__thumb w-img fix">
                      <a href="blog-details.html">
                         <img src="{{ asset('img/frontend/img/blog/blog-2.jpg') }}" alt="">
                      </a>
                   </div>
                   <div class="blog__content">
                      <div class="blog__tag">
                      ...
                      <div class="blog__meta d-flex align-items-center justify-content-between">
                         <div class="blog__author d-flex align-items-center">
                            <div class="blog__author-thumb mr-10">
                               <img src="{{ asset('img/frontend/img/blog/author/author-2.jpg') }}" alt="">
                            </div>
                            <div class="blog__author-info">
                               <h5>Barry Tone</h5>
                            </div>
             ...
             <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                <div class="blog__item white-bg mb-30 transition-3 fix">
                   <div class="blog__thumb w-img fix">
                      <a href="blog-details.html">
                         <img src="{{ asset('img/frontend/img/blog/blog-3.jpg') }}" alt="">
                      </a>
                   </div>
                   <div class="blog__content">
                      <div class="blog__tag">
                      ...
                      <div class="blog__meta d-flex align-items-center justify-content-between">
                         <div class="blog__author d-flex align-items-center">
                            <div class="blog__author-thumb mr-10">
                               <img src="{{ asset('img/frontend/img/blog/author/author-3.jpg') }}" alt="">
                            </div>
                            <div class="blog__author-info">
                               <h5>Barry Tone</h5>
                            </div>
       ...
       <div class="container">
          <div class="cta__inner cta__inner-2 blue-bg fix">
             <div class="cta__shape">
                <img src="{{ asset('img/frontend/img/cta/cta-shape.png') }}" alt="">
             </div>
             <div class="row align-items-center">
