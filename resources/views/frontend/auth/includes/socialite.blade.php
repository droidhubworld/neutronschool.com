...
<a href="{{ route('frontend.auth.social.login', 'facebook') }}" class="sign__social text-start mb-15"><i class="fab fa-facebook-f"></i>@lang('labels.frontend.auth.login_with', ['social_media' => 'Facebook'])</a>
@endif

@if (config('services.google.active'))
<a href="{{ route('frontend.auth.social.login', 'google') }}" class="sign__social g-plus text-start mb-15"><i class="fab fa-google-plus-g"></i>@lang('labels.frontend.auth.login_with', ['social_media' => 'Google'])</a>
@endif
