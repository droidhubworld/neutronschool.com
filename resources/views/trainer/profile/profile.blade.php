    ...
    <div class="col-md-4 col-xl-3">
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <img src="{{ $logged_in_user->picture }}" alt="{{ $logged_in_user->full_name }}" class="img-fluid rounded-circle mb-2" width="128" height="128" />
                <h5 class="card-title mb-0">{{ $logged_in_user->full_name }}</h5>
                <h6 class="card-title mb-0">{{ $logged_in_user->phone }}</h6>
